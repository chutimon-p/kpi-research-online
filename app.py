...
with header_col1:
    # เปลี่ยนมาใช้ URL ที่เสถียรที่สุด (จากสภาการพยาบาลที่มหาวิทยาลัยใช้อ้างอิง หรือ GitHub Assets)
    logo_url = "https://raw.githubusercontent.com/Aekanun2020/STIU-Assets/main/stiu-logo.png"
