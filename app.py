...
@st.cache_resource
def conn_sheets():
    # แก้ไข Syntax Error โดยใช้การย่อหน้าแบบปกติ
...
def load_data():
    ...
    try:
        ...
        if not df_r.empty:
            ...
            # ทำความสะอาดข้อมูลให้เป็นตัวเลขที่ถูกต้อง
...
if menu == "📊 Dashboard & Reports":
    # จัดเตรียมข้อมูล Unique Titles (นับ 1 เรื่อง ไม่ว่าจะมีผู้เขียนกี่คน)
...
# ==========================================
    ...
    with st.form("add_form", clear_on_submit=True):
        ...
        if st.form_submit_button("Submit Data"):
            # 🔍 ตรวจสอบความถูกต้องและชื่อเรื่องซ้ำ
            ...
            if not title_in or not authors_in:
                ...
                st.warning(f"⚠️ Duplicate Detected: '{title_in}' already exists.")
            else:
